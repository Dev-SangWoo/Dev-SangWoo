...
- **User Experience** — 화면뿐 아니라 상태·데이터·API가 어떻게 연결되는지 함께 고민합니다.
- **Collaboration** — 같은 목표와 방향을 바라보며 서로의 강점을 살리는 과정을 중요하게 생각합니다.
- **AI & Engineering** — AI의 불확실성을 통제하고 이해를 기반으로 활용하며, 더 깊은 문제 해결과 시스템 설계에 집중합니다.

배운 것을 팀과 나누며, **개인의 성장이 팀의 성장으로 이어지는 선순환**을 지향합니다.
