...
- **사용자 경험** — 화면뿐 아니라 상태·데이터·API가 어떻게 연결되는지 함께 고민합니다.
- **협업** — 같은 목표와 방향을 바라보며 서로의 강점을 살리는 과정을 중요하게 생각합니다.
- **AI 활용** — AI의 불확실성을 통제하고 이해를 기반으로 활용하며, 더 깊은 문제 해결과 시스템 설계에 집중합니다.
